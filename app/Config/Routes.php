...
$routes->get('/user/order-history', 'User::orderHistory');
...
$routes->match(['get', 'post'], '/checkout/payment', 'Order::payment');
$routes->match(['get', 'post'], '/checkout/paypal', 'Order::pay_by_paypal');
