    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                ...
                <h1 class="pagetitle__heading">Founder's Story</h1>
            </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
    </div><!-- /.container -->
</section><!-- /.page-title -->
    ...
    <div class="container">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-10 offset-lg-1">
                <div class="row pb-50">
                    <img src="/images/team/founder-1.png" class="offset-lg-1">
                </div>
                <div class="post-item">
                    <div class="post__content">
                        <div class="post__desc">
                            <p>Olive Mediterranean Grill was built on the American Dream. The owner, Faisal Ghani, an immigrant to
                                the United States, came from humble roots, with no plan or direction. He got his 1st job at a
                                sandwich shop and worked his way from floors, to driver then manager- and finally owner. Faisal’s
                                dream was to leave the world of sandwiches and bring his favorite cuisine to the city he now loved
                                and called home- hence the birth of Olive Mediterranean Grill. The menu items were carefully curated
                                for a healthy food lover from Chicago. Items like the baba ghanoush the Lentil Soup with a Twist and
                                Chicken Kebob sandwich will make you say O-M-G every time!</p>
                            <p>Aside from being a restaurateur, Faisal is also a fitness enthusiast, and it remains his vision for
                                Olive Mediterranean Grill to give Chicagoans the opportunity to indulge without the guilt! The menu
                                is clean & locally sourced, with all items made fresh daily, and served in recyclable containers.
                                Being good to our bodies, and good to the earth are core company values for the OMG staff.</p>
                            <p>Olive Mediterranean Grill is available 7 days a week across every delivery app, and for takeout in
                                Lincoln Park & Evanston. Eat, Live, Love - Olive Mediterranean Grill!</p>
                        </div><!-- /.post-desc -->
                    </div><!-- /.post-content -->
                </div><!-- /.post-item -->
            </div><!-- /.col-lg-10 -->
