<section id="slider" class="slider slider-layout1">
    <div class="carousel owl-carousel carousel-arrows" data-slide="1" data-slide-md="1" data-slide-sm="1" data-autoplay="true" data-nav="true" data-dots="false" data-space="0" data-loop="true" data-speed="3000" data-transition="swipe" data-animate-out="" data-animate-in="">
        <div class="slide-item align-v-h text-center bg-overlay">
            <div class="bg-img"><img src="/images/backgrounds/OMG_Main_2048x1385.png" alt="slide img"></div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="slide__content">
                            <!-- <span class="slide__subtitle">We Offer You</span> -->
                            <h1 class="slide__title">All of our meals will leave you saying OMG!</h1>
                            ...
                            <a href="https://eatomg-northave.securebrygid.com/zgrid/proc/site/sitep.jsp" class="btn btn__white btn__bordered my-1">View Menu</a>
                        </div><!-- /.slide-content -->
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
        ...
        <div class="slide-item align-v-h text-center bg-overlay bg-overlay-2">
            <div class="bg-img"><img src="/images/backgrounds/OMG_Main_2048x1385-b.png" alt="slide img"></div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="slide__content">
                            <!-- <span class="slide__subtitle">Fresh Ingredient, Tasty Meals</span> -->
                            <h1 class="slide__title"> Olive Mediterranean Grill!</h1>
                            <h2 class="slide__title">(Eat, Live, Love)</h2>
                            <p class="slide__desc"></p>
                            <!-- <a href="reservation.html" class="btn btn__primary mx-2 my-1">Order Now</a> -->
                            <a href="https://eatomg-online-ordering.securebrygid.com/zgrid/themes/10229/portal/index.jsp" class="btn btn__primary mx-2 my-1">Order Now</a>
        ...
        <div class="slide-item align-v-h text-center bg-overlay bg-overlay-2">
            <div class="bg-img"><img src="/images/backgrounds/OMG_Main_2048x1385-c.png" alt="slide img"></div>
            <div class="container">
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="slide__content">
                            <!-- <span class="slide__subtitle">Fresh Ingredient, Tasty Meals</span> -->
                            <h1 class="slide__title">Place your order, and bite into your falafel fantasy today!</h1>
                            <!-- <h2 class="slide__title">(Eat, Live, Love)</h2> -->
                            <p class="slide__desc"></p>
                            <!-- <a href="reservation.html" class="btn btn__primary mx-2 my-1">Discover Our Menu</a> -->
                            <a href="menu-classic.html" class="btn btn__white mx-2 my-1">Get 25% Discount</a>
                        </div><!-- /.slide-content -->
                    </div><!-- /.col-lg-12 -->
                </div><!-- /.row -->
            </div><!-- /.container -->
...
<section class="pt-0">
    <div class="bg-img"><img src="/images/backgrounds/pattern/OMG-Background.png" alt="background"></div>
    <!-- =====================
       Banner layout1
       ======================== -->
                ...
                <div class="col-sm-12 col-md-12 col-lg-12">
                    <div class="banner__content">
                        <div class="banner__content-text" data-aos="fade-right">
                            <div class="banner__content-text-inner">
                                <div class="heading">
                                    ...
                                    <p class="heading__desc"> Olive Mediterranean Grill- Serving up Chicago’s favorite Mediterranean
                                        tastes and flavors that happen to be healthy- since 2010! Fresh baked pita, zesty meats, hummus
                                        and baba ghanoush that will show up in your dreams. All of our meals will leave you saying
                                        O-M-G! Place your order, and bite into your falafel fantasy today! Eat, Live, Love - Olive
                                        Mediterranean Grill!</p>
                        ...
                        <div class="banner__content-img" data-aos="fade-left">
                            <img src="/images/backgrounds/OMG_About Us_620x485.png" alt="banner">
          ...
          <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-8 offset-lg-2">
              ...
              <div class="carousel owl-carousel" data-slide="6" data-slide-md="4" data-slide-sm="3" data-autoplay="true"
                ...
                <div class="client">
                  <a href="#"><img src="assets/images/clients/UE_Logo.png" alt="client"></a>
                </div>
                <div class="client">
                  <a href="#"><img src="assets/images/clients/Grubhub.png" alt="client"></a>
                </div>
                <div class="client">
                  <a href="#"><img src="assets/images/clients/Doordash.png" alt="client"></a>
                </div>
              </div>
            </div>
          </div>
...
<section id="menulayout5" class="menu-layout5 pb-60 bg-overlay bg-overlay-2 bg-parallax">
    <div class="bg-img"><img src="/images/backgrounds/Food-21.jpg" alt="background"></div>
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-12 col-md-12 col-lg-12">
                <div class="menu-wrapper">
                    <nav class="nav nav-tabs justify-content-center">
                        <a class="nav__link active" data-toggle="tab" href="#tab1">Build Your Own</a>
                        <a class="nav__link" data-toggle="tab" href="#tab2">Under The Spotlight</a>
                        <a class="nav__link" data-toggle="tab" href="#tab3">Sides</a>
                        <a class="nav__link" data-toggle="tab" href="#tab4">Sandwiches</a>
                    </nav>
                    <a onclick="swipeLeft();" style="position: absolute;top: 400px;left:-40px;color:#83bb43"><i class="fa fa-angle-left fa-4x"></i></a>
                    <a onclick="swipeRight();" style="position: absolute;top: 400px;right:-40px;color:#83bb43"><i class="fa fa-angle-right fa-4x"></i></a>
                    <div class="tab-content">
                        <div class="tab-pane fade show active" id="tab1">
                            <img src="/images/menu/Olive_Menu_8-a.png" />
                        </div><!-- /.tab  -->
                        <div class="tab-pane fade" id="tab2">
                            <img src="/images/menu/Olive_Menu_8-b.png" />
                        </div><!-- /.tab  -->
                        <div class="tab-pane fade" id="tab3">
                            <img src="/images/menu/Olive_Menu_8-c.png" />
                        </div><!-- /.tab  -->
                        <div class="tab-pane fade" id="tab4">
                            <img src="/images/menu/Olive_Menu_8-d.png" />
                        </div><!-- /.tab  -->
                    </div><!-- /.tab-content  -->
                </div><!-- /.menu-wrapper  -->
            </div><!-- /.col-lg-12 -->
        ...
        <!-- <div class="row">
          <div class="col-sm-12 col-md-12 col-lg-12 text-center">
            <a href="#" class="btn-custom">Full Menu</a>
          </div>
        </div> -->
    </div><!-- /.container -->
                    ...
                    <div class="banner__content-text" data-aos="fade-left">
                        <div class="banner__content-text-inner">
                            <div class="heading mb-40">
                                ...
                                <h2 class="heading__title">Catering</h2>
                                <div class="heading__icon">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20 20">
                                        <path d="M515,925a10,10,0,1,0,10,10A10.011,10.011,0,0,0,515,925Zm7,13.865a2.568,2.568,0,0,1-.651-0.549,3.235,3.235,0,0,0-5.209,0,1.449,1.449,0,0,1-1.146.683,1.419,1.419,0,0,1-1.2-.695,3.2,3.2,0,0,0-2.548-1.3,3.345,3.345,0,0,0-2.605,1.316,2.625,2.625,0,0,1-.64.544,7.953,7.953,0,0,1-.928-2.86h15.862A7.926,7.926,0,0,1,522,938.863ZM507.069,934a7.948,7.948,0,0,1,.928-2.859,2.617,2.617,0,0,1,.64.543A3.345,3.345,0,0,0,511.242,933a3.2,3.2,0,0,0,2.548-1.3,1.423,1.423,0,0,1,1.2-.7,1.452,1.452,0,0,1,1.146.685,3.237,3.237,0,0,0,5.209,0,2.575,2.575,0,0,1,.651-0.55,7.939,7.939,0,0,1,.932,2.865H507.069ZM515,927a7.975,7.975,0,0,1,5.8,2.509,5.325,5.325,0,0,0-.914.806,1.3,1.3,0,0,1-2.292,0,3.287,3.287,0,0,0-5.289.035,1.286,1.286,0,0,1-1.066.648,1.452,1.452,0,0,1-1.145-.683,5.348,5.348,0,0,0-.9-0.8A7.972,7.972,0,0,1,515,927Zm0,16a7.97,7.97,0,0,1-5.808-2.516,5.3,5.3,0,0,0,.9-0.8,1.452,1.452,0,0,1,1.145-.685,1.288,1.288,0,0,1,1.066.649,3.288,3.288,0,0,0,5.289.036,1.3,1.3,0,0,1,2.292,0,5.241,5.241,0,0,0,.914.806A7.972,7.972,0,0,1,515,943Z" transform="translate(-505 -925)"></path>
                                    </svg>
                            ...
                            <a href="#" class="btn btn__primary mx-2 my-1">Order Now</a>
                        </div><!-- /.banner__content-text-inner -->
                    </div><!-- /.banner__content-text -->
                    <div class="banner__content-img" data-aos="fade-right">
                        <img src="/images/backgrounds/OMG_Catering_620x485.png" alt="banner">
                    </div><!-- /.banner__content-img -->
                </div><!-- /.banner__content -->
            </div><!-- /.col-lg-12 -->
        </div><!-- /.row -->
    ...
    <div class="container-fluid col-padding-0">
        <div class="row">
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-1.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-1.png" data-lightbox="lightbox" class="zoom__icon"></a>
            ...
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-2.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-2.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
            <!-- portfolio item #3 -->
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-3.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-3.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
            <!-- portfolio item #4 -->
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-4.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-4.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
            <!-- portfolio item #5 -->
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-5.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-5.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
            <!-- portfolio item #6 -->
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-6.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-6.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
            <!-- portfolio item #7 -->
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-7.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-7.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
            <!-- portfolio item #8 -->
            <div class="col-sm-6 col-md-4 col-lg-3">
                <div class="portfolio-item">
                    <div class="portfolio__img">
                        <img src="/images/gallery/gallery-8.png" alt="portfolio img">
                    </div><!-- /.portfolio-img -->
                    <div class="portfolio__hover">
                        <a href="/images/gallery/gallery-8.png" data-lightbox="lightbox" class="zoom__icon"></a>
                    </div><!-- /.portfolio__hover-->
                </div><!-- /.portfolio-item -->
            </div><!-- /.col-lg-4 -->
        </div><!-- /.row -->
                ...
                <div class="carousel owl-carousel carousel-dots" data-slide="3" data-slide-md="2" data-slide-sm="1" data-autoplay="true" data-nav="false" data-dots="true" data-space="30" data-loop="true" data-speed="800">
                    ...
                    <div class=" testimonial-item">
                        ...
                        <div class="testimonial__content">
                            ...
                            <p class="testimonial__desc">“I was so happy to find Olive Mediterranean restaurant on North Ave.
                                During the COVID-19 pandemic, It was very assuring to see the staff CONSISTENTLY change their vinyl
                                protective gloves REPEATEDLY while serving the customers food. On top of that the food is hot and
                                delicious. Excellent!!”</p>
                        </div><!-- /.testimonial-content -->
                        <div class="testimonial__meta">
                            <h5 class="testimonial__meta-title">Brian T.</h5>
                            <p class="testimonial__meta-desc">South Holland, IL</p>
                    ...
                    <div class=" testimonial-item">
                        ...
                        <div class="testimonial__content">
                            ...
                            <p class="testimonial__desc">“Great food, but portion size leaves something to be desired. See picture
                                for what I got. Everything was fairly warm, and delicious. Chicken kabob was flavorful and tender.
                                Would have liked to have receive hummus by default vs. paying extra, but no biggie. Falafels were
                                good, should have ordered more! Basmati rice was nice and flavorful.”</p>
                        </div><!-- /.testimonial-content -->
                        <div class="testimonial__meta">
                            <h5 class="testimonial__meta-title">Jill M.</h5>
                            <p class="testimonial__meta-desc">Chicago, IL</p>
                        </div><!-- /.testimonial-meta -->
                    </div><!-- /. testimonial-item -->
                    <div class=" testimonial-item">
                        <div class="testimonial__icon"></div>
                        <div class="testimonial__content">
                            ...
                            <p class="testimonial__desc">“OMG! I honestly didn't want to come here at first. I mean there's
                                already a lot of these fast food chipotle/subway like Mediterranean joints around town, but I'm glad
                                my wife convinced me to try this place out.

                                OMG offers a plate where you can choose what kind of meat you want and then three sides. I chose
                                hummus,”</p>
                        </div><!-- /.testimonial-content -->
                        <div class="testimonial__meta">
                            <h5 class="testimonial__meta-title">Jose C.</h5>
                            <p class="testimonial__meta-desc">Chicago, IL</p>
                        </div><!-- /.testimonial-meta -->
                    </div><!-- /. testimonial-item -->
                </div><!-- /.carousel -->
        ...
        <div class="row">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="post-item">
                    <div class="post__img">
                        <a href="#">
                            <img src="/images/blog/grid/1.jpg" alt="post image">
                        </a>
                    </div><!-- /.post__img -->
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="post-item">
                    <div class="post__img">
                        <a href="#">
                            <img src="/images/blog/grid/2.jpg" alt="post image">
                        </a>
                    </div><!-- /.post__img -->
                    <div class="post__content">
                        <div class="post__meta">
            ...
            <div class="col-sm-12 col-md-6 col-lg-4">
                <div class="post-item">
                    <div class="post__img">
                        <a href="#">
                            <img src="/images/blog/grid/3.jpg" alt="post image">
                        </a>
                    </div><!-- /.post__img -->
                    <div class="post__content">
                        <div class="post__meta">
...
<script>
    function swipeLeft() {
        var id = $('.tab-content').find('.show').attr('id');
        $('.tab-content').find('.show').removeClass('show active');
        number = id.substr(3);
        ...
        $('#tab' + newNumber).addClass('show active');
    }
