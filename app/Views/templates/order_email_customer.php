    ...
    <table cellpadding="0" cellspacing="0">
      <tr class="top">
        <td colspan="2">
          <table>
            <tr>
              <td class="title" colspan="2">Your order has been placed!</td>
            </tr>
          </table>
        </td>
      </tr>
      ...
      <tr class="details">
        <td colspan="2">
          ...
          Your order has been placed at <?= $rest['rest_name']; ?>.<br />
          <br />
          Your order number is: <?= $order['order_num']; ?> <br />
          <?php
          $deliver_at = new DateTime($order['deliver_at']);
          $placed_at = new DateTime($order['placed_at']);
          ?>
          Kindly, pick up your order at: <?= $deliver_at->format('h:i A'); ?><br />
          <br />
          Thank you, <br />
          <?= $rest['rest_name']; ?><br /><br />
        </td>
      </tr>
      ...
      <?php foreach ($cart['items'] as $item) : ?>
        <tr class="item">
          <td><?= $item['item_quantity']; ?> x <?= $item['item_name']; ?></td>
