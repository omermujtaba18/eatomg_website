...
$(function () {
    ...
    $('.increase-qty').on('click', function () {
        ...
        var $price = $(this).parent().parent().parent().parent().find('.cart__product-full-price')[0];
        var $total = $(this).parent().parent().parent().parent().find('.cart__product-total')[0];

        var price = parseFloat($price.innerHTML);
        var newTotal = price * $qty.val();
